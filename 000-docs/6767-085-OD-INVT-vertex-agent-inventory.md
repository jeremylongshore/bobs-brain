...
**Document ID:** 6767-085-OD-INVT-vertex-agent-inventory
**Date:** 2025-11-19
...
- [x] Create postmortem (6767-084-PM-MORT)
...
- **Postmortem:** `000-docs/6767-084-PM-MORT-vertex-ai-agents-discovery.md`
- **Deployment Status:** `000-docs/6767-061-PM-NOTE-deployment-status.md`
- **Deployment Runbook:** `000-docs/6767-070-OD-RBOK-deployment-runbook.md`
