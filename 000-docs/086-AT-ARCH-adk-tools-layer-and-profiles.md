...
**Document ID:** 086-AT-ARCH-adk-tools-layer-and-profiles
**Date:** 2025-11-19
...
- **Hard Mode Rules:** `000-docs/053-AA-REPT-hardmode-baseline.md`
- **Department Structure:** `000-docs/082-AT-ARCH-department-complete-structure.md`
