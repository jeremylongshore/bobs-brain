# CLAUDE Working Notes (Archive)

> This file is an archive of historical CLAUDE.md content.
> It is **not** the canonical working guide. See the top-level `CLAUDE.md` for the current, lightweight instructions.
