# 096-DR-STND-repo-registry-and-target-selection.md
...
- **Phase GH2:** `097-AT-ARCH-github-integration-and-repo-ingest.md` (next)
- **Pipeline Architecture:** `094-AT-ARCH-iam-swe-pipeline-orchestration.md`
