...
The IAM department was designed as a **reusable template** (see 6767-104, 6767-105, 6767-106) for other product repositories. However, the current implementation has limitations:
...
### Documentation
- `6767-096-DR-STND-repo-registry-and-target-selection.md` (existing, still accurate)
- `6767-109-PP-PLAN-multi-repo-swe-portfolio-scope.md` (this document)
...
6. `6767-110-AA-REPT-portfolio-orchestrator-implementation.md` - AAR for PORT2
...
**Location:** Design in `6767-111-AT-ARCH-portfolio-ci-slack-integration-design.md`
...
#### 3. Design Document
**Location:** `6767-111-AT-ARCH-portfolio-ci-slack-integration-design.md`
...
- `000-docs/6767-107-RB-OPS-adk-department-operations-runbook.md` - Add portfolio operations

### Deliverables

1. `.github/workflows/portfolio-swe.yml` - Workflow definition
2. `6767-111-AT-ARCH-portfolio-ci-slack-integration-design.md` - Design doc
...
**Mitigation:**
- Document ARV profile standards in 6767-100
...
### Existing Standards
- `6767-093-DR-STND-bob-rag-readiness-standard.md` - RAG readiness (Phase RC1)
...
- `6767-104-DR-STND-iam-department-template-scope-and-rules.md` - Template scope
- `6767-107-RB-OPS-adk-department-operations-runbook.md` - Operations runbook

### PORT Phase Docs (This Series)
- `6767-109-PP-PLAN-multi-repo-swe-portfolio-scope.md` - This document (PORT1 plan)
- `6767-110-AA-REPT-portfolio-orchestrator-implementation.md` - PORT2 AAR (future)
