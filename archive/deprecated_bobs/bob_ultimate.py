...
class BobUltimate:
    ...
    def setup_logging(self):
        ...
        logging.basicConfig(
            ...
            handlers=[logging.FileHandler(f"{log_dir}/bob_ultimate.log"), logging.StreamHandler(sys.stdout)],
        )
    ...
    def query_knowledge(self, query: str, max_results: int = 3) -> List[Dict]:
        ...
        try:
            results = self.knowledge_collection.query(query_texts=[query], n_results=max_results)
            ...
            for doc, meta, dist in zip(
                ...
                if 1.0 - dist > 0.3:  # Relevance threshold
                    knowledge.append({"content": doc, "metadata": meta, "relevance": 1.0 - dist})
            return knowledge
        ...
        try:
            ...
            if request.type == "events_api":
                ...
                self.slack_client.chat_postMessage(
                    channel=channel, text=response, thread_ts=event.get("thread_ts")  # Only thread if already in thread
                )
    ...
    def start(self):
        ...
        try:
            ...
            while self.is_healthy:
                ...
                self.logger.info(
                    f"💓 Health: {health['active_conversations']} conversations, {health['processed_messages']} messages"
                )
