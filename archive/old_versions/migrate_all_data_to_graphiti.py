...
def check_chromadb_data():
    ...
    chroma_locations = ["./chroma_data", os.path.expanduser("~/.bob_brain/chroma"), "./chroma", "../chroma_data"]
...
def check_local_files():
    ...
    knowledge_files = ["knowledge_base.json", "bob_knowledge.json", "shared_knowledge.json", "data/knowledge.json"]
