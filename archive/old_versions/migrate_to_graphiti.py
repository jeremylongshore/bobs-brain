...
async def migrate_firestore_to_graphiti():
    ...
    graphiti = Graphiti(uri="bolt://10.128.0.2:7687", user="neo4j", password="BobBrain2025")
    ...
    test_queries = ["Who is Jeremy Longshore?", "What is DiagnosticPro?", "What technology does Bob use?"]
