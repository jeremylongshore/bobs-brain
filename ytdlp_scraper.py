...
class YTDLPScraper:
    ...
    def extract_knowledge(self, text):
        ...
        # Extract tools
        tools = [
            'multimeter', 'scan tool', 'scanner', 'oscilloscope',
            'pressure gauge', 'test light', 'vacuum pump',
            'compression tester', 'fuel pressure gauge'
        ]
        ...
        # Extract problems
        problems = [
            'won\'t start', 'no start', 'hard start', 'rough idle',
            'misfire', 'overheating', 'no power', 'oil leak',
            'coolant leak', 'check engine', 'warning light'
        ]
