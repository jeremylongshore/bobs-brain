...
class UnifiedScraper:
    ...
    async def scrape_rss_feeds(self) -> List[Dict]:
        ...
        feeds = [
            {"name": "Equipment World", "url": "https://www.equipmentworld.com/feed/", "category": "construction"},
            {"name": "Diesel Progress", "url": "https://www.dieselprogress.com/feed/", "category": "diesel"},
            {
        ...
        for feed_info in feeds:
            try:
                ...
                logger.info(
                    f"   ✅ Scraped {len([i for i in all_items if i['source'] == feed_info['name']])} items from {feed_info['name']}"
                )
    ...
    async def scrape_youtube_transcripts(self) -> List[Dict]:
        ...
        channels = [
            ...
            {"name": "South Main Auto", "channel_id": "UCWng6bxEbxA", "search_terms": ["repair", "diagnosis", "fix"]},
        ]
    ...
    async def scrape_forums(self) -> List[Dict]:
        ...
        forums = [
            {"name": "BobcatForum", "url": "https://www.bobcatforum.com/forums/", "category": "bobcat"},
            {"name": "TractorByNet", "url": "https://www.tractorbynet.com/forums/", "category": "tractors"},
        ]
    ...
    async def scrape_all(self) -> Dict:
        ...
        results = {"rss": [], "youtube": [], "forums": [], "total": 0, "stored": 0}
...
def health():
    ...
    return jsonify({"status": "healthy", "service": "Unified Scraper", "timestamp": datetime.utcnow().isoformat()})
...
def scrape_quick():
    ...
    try:
        ...
        return jsonify(
            {"success": True, "results": results, "message": f"Quick scrape complete: {results['stored']} items stored"}
        )
...
def get_stats():
    ...
    try:
        ...
        if row:
            ...
            return jsonify({"total_records": 0, "sources": 0, "last_scrape": None})
